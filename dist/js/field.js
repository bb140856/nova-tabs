...
Component.options.__file = "resources/js/components/TabTitle.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7d9863ae", Component.options)
  } else {
    hotAPI.reload("data-v-7d9863ae", Component.options)
  }
...
Nova.booting(function (Vue) {
    Vue.component('detail-tabs', __webpack_require__(7));
    Vue.component('form-tabs', __webpack_require__(16));
});
...
var update = __webpack_require__(2)("04b0cc33", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_laravel_nova_src_mixins_BehavesAsPanel__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TabTitle__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TabTitle___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__TabTitle__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_tab_updater__ = __webpack_require__(4);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { TabTitle: __WEBPACK_IMPORTED_MODULE_1__TabTitle___default.a },
    ...
    methods: {
        ...
        handleTabClick: function handleTabClick(tab) {
            ...
            var currentTab = this.$router.currentRoute.query;

            tab.init = true;
            this.activeTab = tab.slug;

            if (updateUri && (!currentTab || currentTab.tab !== tab.slug)) {
                Object(__WEBPACK_IMPORTED_MODULE_2__util_tab_updater__["a" /* changeActiveTab */])(this.$router, tab.slug);
            }
        },
...
var render = function() {
  ...
  return _c("span", { staticClass: "tab-title inline-flex items-center" }, [
    _vm.tab.properties.beforeIcon
      ? _c("span", {
          staticClass: "mr-1",
          domProps: { innerHTML: _vm._s(_vm.tab.properties.beforeIcon) }
        })
      : _vm._e(),
    _vm._v(" "),
    _vm.tab.properties.titleAsHtml
      ? _c("span", {
          domProps: { innerHTML: _vm._s(_vm.tab.properties.title) }
        })
      : _c("span", [_vm._v(_vm._s(_vm.tab.properties.title))]),
    _vm._v(" "),
    _vm.tab.properties.afterIcon
      ? _c("span", {
          staticClass: "ml-1",
          domProps: { innerHTML: _vm._s(_vm.tab.properties.afterIcon) }
        })
      : _vm._e()
  ])
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7d9863ae", module.exports)
  }
}
                ...
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
                    value: tab.slug === _vm.activeTab,
                    expression: "tab.slug === activeTab"
                  }
                ],
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("22dfdc07", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_tab_updater__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TabTitle__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TabTitle___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__TabTitle__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        TabTitle: __WEBPACK_IMPORTED_MODULE_2__TabTitle___default.a
    },
    ...
    watch: {
        errors: {
            handler: function handler() {
                ...
                try {
                    for (var _iterator = Object.keys(this.tabs)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var key = _step.value;
    ...
    mounted: function mounted() {
        var tabs = this.tabs = _.toArray(this.field.fields).reduce(function (tabs, field) {
    ...
    methods: {
        ...
        handleTabClick: function handleTabClick(tab) {
            ...
            if (updateUri && (!currentTab || currentTab.tab !== tab.slug)) {
                Object(__WEBPACK_IMPORTED_MODULE_1__util_tab_updater__["a" /* changeActiveTab */])(this.$router, tab.slug);
            }
        ...
        tabHasErrors: function tabHasErrors(tab) {
            var hasErrors = Object.keys(this.errors.errors).some(function (key) {
                return _.includes(tab.fields.map(function (o) {
                    return o.attribute;
                }), key);
            });
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "div",
        { staticClass: "flex flex-row overflow-x-auto" },
        [
          _vm._l(_vm.tabs, function(tab, key) {
            return _c(
              "div",
              {
                key: key,
                staticClass:
                  "py-5 px-8 border-b-2 focus:outline-none tab cursor-pointer flex items-center",
                class: _vm.getTabClass(tab),
                attrs: { dusk: tab.slug + "-tab" },
                on: {
                  click: function($event) {
